...
export const dialogueData = {
    ...
    "Skills": "Over the years, I’ve honed my skills in various programming languages such as Java, Python, C, C#, MySQL, HTML, CSS, and JavaScript. Alongside these, I’ve become proficient in using tools like Git, GitHub, VSCode, and Visual Studio, which have greatly enhanced my coding and development workflow.",
    ...
    <div style="display: flex; margin-right: 10px;">
        ...
        <div class="Linkdin" style="border: 2px solid #333; padding: 5px 10px; border-radius: 10px; width: 125px; background-color: #0166c8; margin-left: 20px; height: 40px;">
            <p style="display: flex; align-items: center; height: 100%; margin: 0;">
                ...
                <a href="https://www.linkedin.com/in/tanmaygupta17/" target="_blank" style="color: white; text-decoration: none;">Linkedin</a>
            </p>
        </div>
    </div>`
    ...
    // "ContactMe":`For more information or to get in touch with me:
    // <br>
    // ➤ Email: <a href='mailto:your-email@gmail.com'>TanmayGupta1706@gmail.com</a>
    // <br>
    // ➤ GitHub: <a href='https://github.com/TanmayGupta17' target='_blank'>https://github.com/TanmayGupta17</a>`
